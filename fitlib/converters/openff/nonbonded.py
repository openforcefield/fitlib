...
def convert_nonbonded_handlers(
    ...
    potential = fitlib.converters.openff._openff._handlers_to_potential(
        handlers,
        handler_type,
        parameter_cols,
        attribute_cols,
    ...
    for handler, topology, v_site_map in zip(
        ...
        if has_exclusions:
            exclusion_to_scale = fitlib.utils.find_exclusions(topology, v_site_map)
        ...
        parameter_map = fitlib.NonbondedParameterMap(
...
@fitlib.converters.smirnoff_parameter_converter(
    "vdW",
    {
...
def convert_dexp(
    ...
    (
        potential,
        parameter_maps,
    ) = fitlib.converters.openff.nonbonded.convert_nonbonded_handlers(
        handlers,
        "DoubleExponential",
        topologies,
        v_site_maps,
    ...
    potential.type = fitlib.PotentialType.VDW
...
def _convert_charge_increment_handlers(
    ...
    potential_bci = fitlib.converters.openff._openff._handlers_to_potential(
